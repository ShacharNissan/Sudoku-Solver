...
public class Cell extends StackPane {
	...
	public void setUnAvailable(int value) {
		this.setUnAvailable(String.format("%d", value));
	}
	...
	private TextField createTextField() {
		...
		tf.setOnKeyPressed(event -> {
			...
			case TAB:
				SudokuBoard.focusNext();
				event.consume(); // <-- stops passing the event to next
				break;
			case UP:
				SudokuBoard.setFocus(this, -1, 0);
				break;
			case DOWN:
				SudokuBoard.setFocus(this, 1, 0);
				break;
			case LEFT:
				SudokuBoard.setFocus(this, 0, -1);
				break;
			case RIGHT:
				SudokuBoard.setFocus(this, 0, 1);
				break;
